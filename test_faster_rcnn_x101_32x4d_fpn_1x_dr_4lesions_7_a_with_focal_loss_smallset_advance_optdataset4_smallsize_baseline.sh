...
config_dir=configs/faster_rcnn_dr_4lesions/faster_rcnn_x101_32x4d_fpn_1x_dr_4lesions_7_a_with_focal_loss_smallset_advance_optdataset4_smallsize_baseline.py
model_dir=/data0/qilei_chen/AI_EYE/BostonAI4DB7/work_dirs/faster_rcnn_r50_fpn_1x_with_focal_loss_smallset_advance_optdataset4_smallsize_baseline

#python3 tools/test.py ${config_dir} ${model_dir}/epoch_1.pth --gpus 1 --out ${model_dir}/e1_results.pkl --eval bbox
#python3 tools/test.py ${config_dir} ${model_dir}/epoch_2.pth --gpus 1 --out ${model_dir}/e2_results.pkl --eval bbox
