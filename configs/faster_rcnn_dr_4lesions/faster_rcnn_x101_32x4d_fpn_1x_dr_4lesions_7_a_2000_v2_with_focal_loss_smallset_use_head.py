...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_strides=[i*input_stride/2 for i in [2, 4, 8, 16, 32, 64]],
    ...
    bbox_roi_extractor=dict(
        ...
        featmap_strides=[i*input_stride/2 for i in [2, 4, 8, 16, 32]],),
    bbox_head=dict(
...
log_level = 'INFO'
work_dir = data_root+'work_dirs/faster_rcnn_r50_fpn_1x_2000_v2_with_focal_loss_smallset_use_head'
load_from = None
