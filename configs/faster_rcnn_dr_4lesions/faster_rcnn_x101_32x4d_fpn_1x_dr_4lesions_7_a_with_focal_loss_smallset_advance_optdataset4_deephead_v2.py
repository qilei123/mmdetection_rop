...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_strides=[4, 8, 16, 32, 64, 128, 256,514],
...
log_level = 'INFO'
work_dir = data_root+'work_dirs/faster_rcnn_r50_fpn_1x_with_focal_loss_smallset_advance_optdataset4_deephead_v2'
load_from = None
