...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_train2014_v2.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_val2014_v2.json',
...
log_level = 'INFO'
work_dir = data_root+'work_dirs/faster_rcnn_r50_fpn_1x_with_focal_loss_smallset_advance_optdataset2'
load_from = None
