...
def single_test(model, data_loader, show=False):
    ...
    for i, data in enumerate(data_loader):
        ...
        #print(result)
        if show:
            model.module.show_result(data, result, dataset.img_norm_cfg,score_thr = 0.05)#out_file='/data0/qilei_chen/Development/show_test/test.jpg')
...
def main():
    ...
    Result_not_Exist = True
    if os.path.exists(args.out):
        Result_not_Exist = False
