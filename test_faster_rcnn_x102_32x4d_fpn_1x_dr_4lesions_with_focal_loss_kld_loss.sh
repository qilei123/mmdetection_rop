...
config_dir=configs/faster_rcnn_dr_4lesions/faster_rcnn_x102_32x4d_fpn_1x_dr_4lesions_with_focal_loss_kld_loss.py
model_dir=/data0/qilei_chen/AI_EYE/BostonAI4DB7/work_dirs/faster_rcnn_r50_fpn_1x_with_focal_loss_kld_loss
