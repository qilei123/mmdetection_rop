...
config_file=configs/faster_rcnn_dr_4lesions/faster_rcnn_x101_32x4d_fpn_1x_dr_4lesions_7_a_with_focal_loss_smallset_advance_optdataset4_deephead_v1_with_pseudo_gt_v1_with_nms.py
sh tools/dist_train_DR_4lesions_3000.sh ${config_file} 1
