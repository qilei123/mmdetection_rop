...
config_dir=configs/faster_rcnn_rop/faster_rcnn_x101_64x4d_fpn_1x_ridge_in_one_with_randflip.py
model_dir=/data0/qilei_chen/AI_EYE/ROP_DATASET/9LESIONS/work_dirs/faster_rcnn_r50_fpn_1x_rop_ridge_in_one_with_randflip
